...
#################################################################
#################################################################
# Name - signalp_parse_v7_generic.py
...
#   The master shell script it is called from (main_signalp_shellparse.sh) iterates over many files of the type
#   997_signalp_neg, 997_signalp_pos and repeatedly call this program.
#
...
#
# Output - 1003_signalp_output_parsed.txt (no header file generated)
#       1003	PROKKA_00001    N	0.136     0.122 N   N 
#       1003	PROKKA_00002    N	0.288     0.270 N   N
#
#
# Example - python signalp_parse_v7_generic.py 1003 '1003_pasted_negposfile.txt' '1003_signalp_output_parsed.txt'
#
# License - GNU GPL
#
# Change History - 
#                   12th September 2014  - Creation by Soumya Banerjee
#                   17th September 2014  - Modified by Soumya Banerjee
#                                           redundant commented code removed
#
#################################################################
#################################################################
                ...
                for sub_string in str_split_line:
                    if sub_string == 'N' or sub_string == 'Y':
                        if iSecondYFound == 0:
                            ...
                            output_file_ptr.write('\t'.join([ str(iPartition_number), temp_str_name, temp_str_Dthreshold, temp_str_signalp, str_split_line[iColCount - 1], str_split_line[iColCount - 2], temp_str_signalp_output_FINAL ]) + '\n')
